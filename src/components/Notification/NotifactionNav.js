    ...
    return (
        <>
            ...
            >
                <Tab
                    label={
                        <Badge color="primary" badgeContent={notificationCount} sx={{ color: '#000', backgroundColor: '#fff' }}>                            Notifications
                        </Badge>
                    }
                    sx={{ textTransform: 'none', fontWeight:'bold', fontSize: 'var(--font-medium)','&:hover': {color: 'var(--color-black)',} }}
                />
