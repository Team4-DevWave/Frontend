...
function Comments() {
  ...
  //       const lastPost = posts[posts.length - 1]; // Get the last post

  //       if (lastPost.text_body) {
  //         const mappedData = {
  //           id: lastPost._id,
  //           title: lastPost.title,
  //           content: lastPost.text_body,
  //           time: lastPost.postedTime,
  //           votes: lastPost.votes,
  //           numviews: lastPost.numViews,
  //           spoiler: lastPost.spoiler,
  //           nsfw: lastPost.nsfw,
  //           locked: lastPost.locked,
  //           approved: lastPost.approved,
  //           mentioned: lastPost.mentioned,
  //         };
  //         console.log("mappeddata", mappedData.content);
  //         setPost(mappedData);
  //       }
